@testset "MortalityTables from File" begin
    ...
    @testset "SOA tables" begin
        ...
        @testset "Ultimate Only SOA table" begin
            ...
            @test q(cso1980.ultimate,35,1) ≈ .00118
            @test q(cso1980,35,1) ≈ .00118
            @test q(cso1980.ultimate,35,1:2) ≈ [.00118,0.00128]
            @test q(cso1980.ultimate,35,1:2) ≈ [.00118,0.00128]
            @test q(cso1980.ultimate,35,1) ≈ .00118
            @test q(cso1980.ultimate,35,61) ≈ .27302
            @test q(cso1980.ultimate,95,1) ≈ .27302
        ...
        @testset "2001 CSO" begin
            ...
            @test q(cso2001.select,35,1) ≈ .00037
            @test q(cso2001.select,35,61) ≈ .26719
            @test q(cso2001.ultimate,16,1) ≈ .00041
            @test q(cso2001.ultimate,95) ≈ .26719
            ...
            @testset "duration ranges" begin
                ...
                @test q(cso2001.select,35,1:25) == [0.00037,0.00043,0.00049,0.00057,0.00063,0.0007,0.00077,0.00084,0.00092,0.00101,0.00114,0.00127,0.00143,0.00159,0.00174,0.00188,0.00208,0.00231,0.00251,0.00279,0.00315,0.00357,0.00406,0.00461,0.00508]
